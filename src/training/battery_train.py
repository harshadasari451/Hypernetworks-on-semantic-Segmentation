...
from src.data_loaders.Battery_unet_hyp_dataloader import BatteryDataset
...
# Load dataset
train_dataset = BatteryDataset(image_dir, label_dir, model_unet)
...
checkpoint_path = "apr8_exp_battery/checkpoint_epoch_0.pth"  

...
class BatteryDataset(Dataset):
    ...
    def __getitem__(self, i):
        ...
        input_images = torch.as_tensor(image.copy()).float().contiguous()
        labels = torch.as_tensor(new_masks.copy())
        img_paths = self.images_fps[i]
        
        return input_images, labels, img_paths